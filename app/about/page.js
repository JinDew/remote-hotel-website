    ...
    <div className="grid items-center grid-cols-5 text-lg gap-x-24 gap-y-32">
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          ...
          <p>
            Our total <span>{cabinsNum}</span> luxury cabins provide a cozy
            base, but the real freedom and peace you'll find in the surrounding
      ...
      <div className="relative col-span-2 aspect-video aspect-square">
        <Image
          fill
          src="/about-2.jpg"
